...
namespace GraceBot.Tests
{
    ...
    public class AppTests
    {
        ...
        public async Task RunWithBadWordTest()
        {
            ...
            mFactory.Verify(f => f.GetBotManager().ReplyToActivityAsync("Failed", _activity,null));
        }
        ...
        public async Task SlackForwardTest()
        {
            ...
            mFactory.Setup(o => o.GetActivityDefinition().FindDefinition(It.IsAny<string>())).Returns(value);
